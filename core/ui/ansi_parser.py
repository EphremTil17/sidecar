...
class ANSIParser:
    """
    Parser for converting ANSI escape sequences to Qt-compatible formatting.
    """

    # ANSI color code mappings (colorama standard)
    ANSI_COLORS: ClassVar[dict[str, QColor]] = {
    ...
    ANSI_ESCAPE: ClassVar[re.Pattern] = re.compile(r"\x1b\[([0-9;]*)m")
